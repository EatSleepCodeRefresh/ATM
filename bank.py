...
class SavingsAccount(object):
	...
	def deposit(self, amount):
		"""Deposit the given amount and returns the new balance."""
	...
	def computerInterest(self):
		...
		self._deposit(interest)
		return interest
		
class Bank(object):

	def __init__(self, fileName = None):
		"""Creates a new dictionary to hold accounts. If a filename is provided, loads the accounts from a file of pickled accounts."""
		self._accounts = {}
	...
	def save(self, fileName = None):
		"""Saves pickled accounts to a file. The parameter allows the suser to change filenames."""
		if fileName != None:
			self._filename = fileName
